...
pub const MAX_LOG_N_ROWS_PER_TABLE: [(Table, usize); 5] = [
    ...
    (Table::poseidon16(), 20), // permute-only (least frequent); lowered from 21 to stay within WHIR commitment surface with 5 tables
    (Table::poseidon16_out4(), 21),
    (Table::poseidon16_out8(), 21),
];
