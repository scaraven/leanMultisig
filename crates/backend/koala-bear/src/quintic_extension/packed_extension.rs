...
impl<F: Field, PF: PackedField<Scalar = F>> Distribution<PackedQuinticExtensionField<F, PF>> for StandardUniform
where
    ...
    PF: PackedField<Scalar = F>,
{
    ...
    const ZERO: Self = Self { value: [PF::ZERO; 5] };
...
impl<F> PackedFieldExtension<F, QuinticExtensionField<F>> for PackedQuinticExtensionField<F, F::Packing>
where
    F: QuinticExtendable,
{
    #[inline]
