...
use field::{InjectiveMonomial, PrimeCharacteristicRing};

use crate::{
    FieldParameters, MontyField31, MontyParameters, Poseidon2ExternalLayerMonty31, Poseidon2InternalLayerMonty31,
...
impl<FP, ILBP, const WIDTH: usize> GenericPoseidon2LinearLayers<WIDTH> for GenericPoseidon2LinearLayersMonty31<FP, ILBP>
where
    FP: FieldParameters,
