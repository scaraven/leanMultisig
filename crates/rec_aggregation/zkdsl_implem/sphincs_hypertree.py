...
@inline
def hypertree_merkle_verify(pk_seed_offset, tree_adrs0, layer_leaf_index, leaf_node, auth_path, root_out):
    ...
    adrs_compress_hcl(pk_seed_offset, tree_adrs0, adrs1_buf0[0], right0, after_bit0)
    ...
    do_5_hypertree_merkle_level(sub_indices[0], pk_seed_offset, tree_adrs0, 1,
    ...
    do_5_hypertree_merkle_level(sub_indices[1], pk_seed_offset, tree_adrs0, 6,
                                 adrs1_chunk1, rem_chunk1, layer_leaf_index,
                                 after_chunk0, auth_path + (1 + MERKLE_LEVEL_STEP) * HALF_DIGEST_LEN, root_out)
    return

@inline
def hypertree_verify(pk_seed_offset, fors_pubkey, layer_leaf_indices, expected_pk):
    ...
    #   3. Walk the 11-level auth path: hypertree_merkle_verify(pk_seed_offset, layer, layer_tree_address, ...).
    ...
    wots_encode_and_complete(msg_0, wots_hash_adrs0_0, kp_adrs1_0, randomness_ptr_0, chain_tips_ptr_0,
                              pk_seed_offset, wots_pk_adrs0_0, kp_adrs1_0, wots_leaf_0)

    tree_adrs0_0 = 0 + (ADRS_TREE * (2 ** ADRS0_TYPE_SHIFT)) + (layer_tree_address_0 * (2 ** ADRS0_TREE_SHIFT))
    layer_root_0 = Array(HALF_DIGEST_LEN)
    hypertree_merkle_verify(pk_seed_offset, tree_adrs0_0, layer_leaf_indices[0],
    ...
    wots_encode_and_complete(msg_1, wots_hash_adrs0_1, kp_adrs1_1, randomness_ptr_1, chain_tips_ptr_1,
                              pk_seed_offset, wots_pk_adrs0_1, kp_adrs1_1, wots_leaf_1)

    tree_adrs0_1 = 1 + (ADRS_TREE * (2 ** ADRS0_TYPE_SHIFT)) + (layer_tree_address_1 * (2 ** ADRS0_TREE_SHIFT))
    layer_root_1 = Array(HALF_DIGEST_LEN)
    hypertree_merkle_verify(pk_seed_offset, tree_adrs0_1, layer_leaf_indices[1],
    ...
    wots_encode_and_complete(msg_2, wots_hash_adrs0_2, kp_adrs1_2, randomness_ptr_2, chain_tips_ptr_2,
                              pk_seed_offset, wots_pk_adrs0_2, kp_adrs1_2, wots_leaf_2)

    tree_adrs0_2 = 2 + (ADRS_TREE * (2 ** ADRS0_TYPE_SHIFT))
    hypertree_merkle_verify(pk_seed_offset, tree_adrs0_2, layer_leaf_indices[2],
